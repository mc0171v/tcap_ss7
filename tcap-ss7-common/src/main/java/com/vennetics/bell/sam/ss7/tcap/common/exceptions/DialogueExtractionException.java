 ...
 */
public class DialogueExtractionException extends SpecificServiceException {

    private static final long serialVersionUID = 2598998425759025626L;

    public DialogueExtractionException(final String message) {
        super(ServiceErrorMessageType.BAD_SS7_DIALOGUE_EXTRACTION, message);
    }
