 ...
 */
public class BadTBCDException extends SpecificServiceException {

    private static final long serialVersionUID = 2598998425759025626L;

    public BadTBCDException(final String message) {
        super(ServiceErrorMessageType.BAD_SS7_TBCD, message);
    }
