...
public class SamTcapEventListener implements ISamTcapEventListener {
    ...
    @Override
    public IDialogue beginDialogue(final TcapDialogue tcapDialogue, final CountDownLatch cDl) {
        final IDialogue dialogue = dialogueSetup(tcapDialogue, cDl);
        return dialogue;
    }

    @Override
    public IDialogue continueDialogue(final TcapDialogue tcapDialogue, final CountDownLatch cDl) {
        final IDialogue dialogue = dialogueSetup(tcapDialogue, cDl);
        return dialogue;
    }
    
    @Override
    public IDialogue endDialogue(final TcapDialogue tcapDialogue, final CountDownLatch cDl) {
        final IDialogue dialogue = dialogueSetup(tcapDialogue, cDl);
        return dialogue;
    }
    ...
    private IDialogue dialogueSetup(final TcapDialogue tcapDialogue, final CountDownLatch cDl) {
        final IDialogue dialogue = new Dialogue(this, tcapDialogue); 
        dialogue.setLatch(cDl);
        return dialogue;
    }
    /**
