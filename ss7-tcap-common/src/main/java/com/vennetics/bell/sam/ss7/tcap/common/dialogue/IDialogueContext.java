...
public interface IDialogueContext {
    ...
    /***
     * Begin a TCAP dialogue
     * @param tcapDialogue
     *     the TCAP dialogue to begin
     * @param cDl
     *     countdown latch on result
     * @return
     *     the dialogue
     */
    IDialogue beginDialogue(TcapDialogue tcapDialogue, CountDownLatch cDl);

    /***
     * Continue a TCAP dialogue
     * @param tcapDialogue
     *     the TCAP dialogue to continue
     * @param cDl
     *     countdown latch on result
     * @return
     *     the dialogue
     */
    IDialogue continueDialogue(TcapDialogue tcapDialogue, CountDownLatch cDl);

    /***
     * End a TCAP dialogue
     * @param tcapDialogue
     *     the TCAP dialogue to end
     * @param cDl
     *     countdown latch on result
     * @return
     *     the dialogue
     */
    IDialogue endDialogue(TcapDialogue tcapDialogue, CountDownLatch cDl);
}
