...
private TcapEventListener mockListener;
    ...
    private static final byte[] EXPECTED_MSISDN_STRING_LOC_STATE = { Tools.getLoByteOf2(0xA0), 0x06, Tools.getLoByteOf2(0x81), 0x04, Tools.getLoByteOf2(0x89), 0x67, 0x45,
            Tools.getLoByteOf2(0xF3), Tools.getLoByteOf2(0xA1), 0x04, Tools.getLoByteOf2(0x80), 0x00, Tools.getLoByteOf2(0x81), 0x00, Tools.getLoByteOf2(0x83), 0x04, 0x21, 0x43, 0x34, 0x12};
