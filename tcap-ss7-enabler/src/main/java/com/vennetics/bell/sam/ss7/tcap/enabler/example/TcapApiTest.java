...
public class TcapApiTest {
    ...
    protected static boolean BB_TEST_TRACE = true;
    ...
    public TcapApiTest(int std) {
        ...
        if (m_oneStack) {
            ...
            m_userAddressA1 =
                    new TcapUserAddress(m_spcA, (short)99);
                m_userAddressB1 =
                    new TcapUserAddress(m_spcA,(short)98);
                m_userAddressA2 =
                    new TcapUserAddress(m_spcA,(short)99);
                m_userAddressB2 =
                    new TcapUserAddress(m_spcA,(short)98);
           ...
           /* m_userAddressA1 =
            ...
            m_userAddressA1 =
                    new TcapUserAddress(m_spcA, (short)99);
                m_userAddressB1 =
                    new TcapUserAddress(m_spcB,(short)98);
                m_userAddressA2 =
                    new TcapUserAddress(m_spcA,(short)99);
                m_userAddressB2 =
                    new TcapUserAddress(m_spcB,(short)98);
...
//                0x08, 0x10, 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x01 };
        final byte[] bytes = {0x30, 0x10, Tools.getLoByteOf2(0xA0), 0x0E, 0x02, 0x02, 0x01, 0x03, Tools.getLoByteOf2(0x80),
                0x08, 0x10, 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x01 };
