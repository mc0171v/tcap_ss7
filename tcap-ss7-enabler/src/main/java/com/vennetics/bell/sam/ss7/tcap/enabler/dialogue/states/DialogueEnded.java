...
public class DialogueEnded extends AbstractDialogueState implements IDialogueState {

    private static final Logger logger = LoggerFactory.getLogger(DialogueEnded.class);
    
    private static final byte[] OPERATION_END_DIALOGUE =       { 0x02};    
    public DialogueEnded(final IDialogueContext context) {
        super(context);
    }
    ...
    throws SS7Exception, VendorException {
        ...
        try {
            ...
            if (operation[0] == OPERATION_END_DIALOGUE[0]) {
	...
	public ResultReqEvent createResultReq(final java.lang.Object source, final int dialogId, final int invokeId,
