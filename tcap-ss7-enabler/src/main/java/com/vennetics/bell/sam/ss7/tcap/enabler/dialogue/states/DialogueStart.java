...
public class DialogueStart extends AbstractDialogueState implements IDialogueState {
    ...
    private static String STATE_NAME = "DialogueStart";
    
    public DialogueStart(final IDialogueContext context, IDialogue dialogue) {
    ...
    public void startDialogue() {
        ...
        try {
            ...
            this.dialogue.setDialogueId(dialogueId);
            ...
            invokeReq = createInvokeReq(context.getTcapEventListener(),
                                        invokeId,
            ...
            // ----- Build begin request:
            beginReq = createBeginReq(context.getTcapEventListener(), dialogueId);
            currentReq = beginReq;
    ...
    */
	...
	public void processResultIndEvent(ResultIndEvent event) throws SS7Exception {
		...
		dialogue.setState(new DialogueAnswer(context, dialogue));
		dialogue.activate();
	}
