...
public class DialogueStartTest {
    ...
    public void setup() throws Exception {
        objectToTest = new DialogueStart(mockDialogueContext, mockDialogue);
    }
    ...
    public void shouldHandleResultIndEventAnsi96() throws Exception {
    	final ResultIndEvent resultIndEvent = new ResultIndEvent(mockTcapListener, DIALOGUE_ID, true, true);
    	...
    	verify(mockDialogue).setState(isA(DialogueAnswer.class));
    }
